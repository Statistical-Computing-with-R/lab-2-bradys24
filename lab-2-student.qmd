...
character  : species_id, sex, day_of_week, plot_type, genus, species...
double  : record_id, month, day, year, plot_id, hindfoot_length, ...
date : date
<!-- You can either write code here or in the code chunk for #1, but I **must** see the code you used to address this question!  -->
...
ggplot(data = surveys,
  ...
  labs(x = "Weight",
       y = "", 
       title = "Comparison Between Hindfoot Length and Weight by Species",
       subtitle = "Y - Hindfoot Length")
```
